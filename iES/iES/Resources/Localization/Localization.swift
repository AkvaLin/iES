...
//  iES
//
//  Created by Никита Пивоваров on 26.02.2025.
//

import SwiftUI

enum Localization {
    static var appSettings: String { String(localized: "appSettings") }
    ...
    static var deleteGame: String { String(localized: "deleteGame") }
    static var deleteGameAlert: String { String(localized: "deleteGameAlert") }
    static var deleteGameSaveAlert: String { String(localized: "deleteGameSaveAlert") }
    static var deleteSaveData: String { String(localized: "deleteSaveData") }
    ...
    static var sortByName: String { String(localized: "sortByName") }
    static var sortByRecentPlayed: String { String(localized: "sortByRecentlyPlayed") }
